...
#### Detailed Transformation Sub-pipelines:

* **CSV Ingestion Transformation:**
  ![CSV Files Transformation](doc/csv_files_transformation.png)

* **Database Records Transformation:**
  ![Database Records Transformation](doc/db_transformation.png)

### 4. HDFS Storage & Error Routing
![HDFS Output](doc/hdfs_output.jpg)
...
To verify the correctness of the pipeline, we can compare the raw ingested data with the final processed records in HDFS.

### Raw Data Before Transformation
Shows missing values and unformatted records as they arrive:
![Raw Data Before Transformation](doc/raw_data_before_transformation.jpg)

### Transformed Data Output in PySpark
Shows clean, formatted, and deduplicated records verified using PySpark:
![Sample Data Output](doc/pyspark_output.jpg)
